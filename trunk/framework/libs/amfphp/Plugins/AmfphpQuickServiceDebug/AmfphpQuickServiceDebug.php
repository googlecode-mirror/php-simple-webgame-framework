...
class AmfphpQuickServiceDebug implements Amfphp_Core_Common_IDeserializer, Amfphp_Core_Common_IDeserializedRequestHandler, Amfphp_Core_Common_IExceptionHandler, Amfphp_Core_Common_ISerializer {
    ...
    public function  __construct(array $config = null) {
        ...
        $hookManager->addFilter(Amfphp_Core_Gateway::FILTER_DESERIALIZER, $this, "getHandlerFilter");
        $hookManager->addFilter(Amfphp_Core_Gateway::FILTER_DESERIALIZED_REQUEST_HANDLER, $this, "getHandlerFilter");
        $hookManager->addFilter(Amfphp_Core_Gateway::FILTER_EXCEPTION_HANDLER, $this, "getHandlerFilter");
        $hookManager->addFilter(Amfphp_Core_Gateway::FILTER_SERIALIZER, $this, "getHandlerFilter");
    }
